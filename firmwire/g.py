...
assembly_code = b"\xe1\x03\x1f\xaa\x01\x11\x1e\xd5\x01\x00\x84\xd2\x21\x40\x1e\xd5\xe0\x03\x9f\xd6"
arm_code_nop = b"\x39\x15\x00\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3\x00\xf0\x20\xe3"
...
for i in range(5):
    ...
    r3 = hex(qemu.read_register("r3"))[2:]
    r4 = hex(qemu.read_register("r4"))[2:]
    pc = hex(qemu.read_register("pc"))[2:]
    print(f"arm: {i} {pc=} {r0=} {r2=} {r3=} {r4=}")
